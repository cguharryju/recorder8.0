...
from trips.views import recorder, model_form_upload, upload, name_post, set_name, upload_word, model_form_uploadRecog,uploadRecog,recog,recognizer,main,upload_file,self_recorder,self_name_post,name_post2
